...
## Speech materials 
We prepared nine Chinese sentences for speech materials. Each sentence includes one of the following nine vowels: [i], [y], [u], [e], [o], [ə], [ɤ], [a], [ɑ]. Each vowel appears after the aspirated bilabial stop [p] with a high tone (55).
...
tidy_df %>% 
  ...
  #                                 "o", "ə",
  #                                 "ɤ", "a",
  #                                 "a"))  #reorder vowel based on IPA order
```
